...
(function ($) {
    ...
    * Input Number Quantity
	...
	$(".js-sidebar-open").on('click', function () {
        ...
        $('.fixed-sidebar-responsive').addClass('open');
        return false;
    });
...
window.onload = function () {
  ...
  $('.slider-check-0').on('click', function () {
    swipers = [];

    $('.btn-next').attr('data-check', 0);
    ...
    $('.btn-next').on('click', function () {
      ...
      var sliderID = $(this).closest('.slider-slides').siblings('.swiper-container').attr('id');
      if (check== 0){
        $('.check-slider-0').trigger('click');
        $(this).attr('data-check', 1);
      }
      swipers['swiper-'+sliderID].slideNext();
      console.log('btn-next: ' +sliderID);
    });
    ...
    $('.btn-prev-without').on('click', function () {
      ...
      swipers['swiper-'+sliderID].slidePrev();
      //console.log('btn-next-without ' +sliderID);
    });
    ...
    if (checkOuttime) {
      clearInterval(checkOuttime);
    }
    checkOuttime = setInterval(myTimer, 3000);
    setTimeout(function() {
      myTimer2();
    }, 30000);
...
CRUMINA.StickySidebar = function () {
	...
	var $header_standard = $('.header--standard');

	$('.crumina-sticky-sidebar').each(function () {

	var sidebar = new StickySidebar (this, {
		topSpacing: $header.height() + $header_standard.height(),
		bottomSpacing: 0,
