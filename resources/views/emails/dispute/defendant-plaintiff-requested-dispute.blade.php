...
<body class="o_body o_bg-light"
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-primary o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-white"
                                    align="center"
                                    style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #FF0A03;color: #ffffff;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="o_sans o_text o_text-white o_b-white o_px o_py o_br-max"
                                                    ...
                                                    <img src="{{ asset('public/assets/images/email/dispute/warning-24-white.png') }}"
                                    ...
                                    <h2 class="o_heading o_mb-xxs"
                                        ...
                                        Milestone Disputed!</h2>
                                    <p style="margin-top: 0px;margin-bottom: 20px;">Hi
                                        <span>{{ $defendant->full_name }}</span>,
                                        {{ $plaintiff->full_name }} has requested to enter a dispute with you! Please
                                        review the request
                                        details below:</p>
                                            ...
                                            <tr>
                                                <td width="300" class="o_btn o_bg-white o_br o_heading o_text"
                                                    ...
                                                    <a class="o_text-primary"
                                                        ...
                                                        style="text-decoration: none;outline: none;color: #FFFFFF;display: block;padding: 12px 24px;mso-text-raise: 3px;">Dispute
                                                        Panel &nbsp;→</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <div class=" o_text o_text-secondary "
                                        ...
                                        <div class="o_px-xs o_sans o_text o_text-secondary o_left "
                                            ...
                                            <p class="o_text o_text-secondary"
                                                ...
                                                <span><strong>Project ID: #{{ $project->id }}</strong></span> </p>
                                            <p
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-white o_sans o_text-xs o_text-light o_px-md o_pt-xs" align="center"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;">PLAINTIFF VS. DEFENDANT</p>
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                        <tbody>
                                            <tr>
            ...
            <tr>
                <td class="o_bg-light o_px-xs" align="center"
                    ...
                    <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
                        ...
                        <tbody>
                            <tr>
                                <td class="o_re o_bg-white o_px" align="center"
                                    style="font-size: 0;vertical-align: top;background-color: #ffffff;padding-left: 16px;padding-right: 16px;">
                                    <!--[if mso]><table cellspacing="0" cellpadding="0" border="0" role="presentation"><tbody><tr><td width="300" align="center" valign="top" style="padding: 0px 8px;"><![endif]-->
                                    <div class="o_col o_col-3 o_col-full"
                                        ...
                                        <div class="o_px-xs o_sans o_text-xs o_text-light o_center"
                                            style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;color: #82899a;text-align: center;padding-left: 8px;padding-right: 8px;">
                                            <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;"><a
                                                    class="o_text-primary"
                                                    href="{{ route('user.timeline', ['id' => $plaintiff->id]) }}"
                                                    style="text-decoration: none;outline: none;color: #126de5;"><img
                                                        class="o_br-max" src="{{ $plaintiff->avatar }}" width="96"
                                                        height="96" alt=""
                                                        style="max-width: 84px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;border-radius: 96px;"></a>
                                            </p>
                                            <p class="o_text"
                                                style="font-size: 16px;line-height: 24px;margin-top: 0px;margin-bottom: 0px;">
                                                <a class="o_text-dark"
                                                    href="{{ route('user.timeline', ['id' => $plaintiff->id]) }}"
                                                    style="text-decoration: none;outline: none;color: #242b3d;"><strong
                                                        style="color: #242b3d;">{{ $plaintiff->full_name }}</strong></a>
                                            </p>
                                            <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 8px;">Plaintiff</p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td><td width="300" align="center" valign="top" style="padding: 0px 8px;"><![endif]-->
                                    <div class="o_col o_col-3 o_col-full"
                                        ...
                                        <div class="o_px-xs o_sans o_text-xs o_text-light o_center"
                                            ...
                                            <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;"><a
                                                    class="o_text-primary"
                                                    href="{{ route('user.timeline', ['id' => $defendant->id]) }}"
                                                    style="text-decoration: none;outline: none;color: #126de5;"><img
                                                        class="o_br-max" src="{{ $defendant->avatar }}" width="96"
                                                        height="96" alt=""
                                                        style="max-width: 84px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;border-radius: 96px;"></a>
                                            </p>
                                            <p class="o_text"
                                                ...
                                                <a class="o_text-dark"
                                                    href="{{ route('user.timeline', ['id' => $plaintiff->id]) }}"
                                                    style="text-decoration: none;outline: none;color: #242b3d;"><strong
                                                        style="color: #242b3d;">{{ $defendant->full_name }}</strong></a>
                                            </p>
                                            <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 8px;">Defendant</p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                </td>
    ...
    @include('emails.dispute.partials.dispute-project-milestone')
