              ...
              <tr>
                <td class="o_bg-primary o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-white" align="center"
                    ...
                    <tbody>
                      <tr>
                        <td class="o_sans o_text o_text-white o_b-white o_px o_py o_br-max" align="center"
                          ...
                          <img src="{{ asset('public/assets/images/email/dispute/milestone-paid-white.png') }}"
                  ...
                  <h2 class="o_heading o_mb-xxs"
                    ...
                    Dispute Paid!</h2>
                  <p>Hi <span>{{ $receiver->full_name }}</span>, $240[TODO] USD (80%[TODO] of Milestone) has been
                    deducted and sent to you from <span>{{ $sender->full_name }}</span> for Dispute ID:
                    #{{ $dispute->id }} </p>
                    ...
                    <tbody>
                      <tr>
                        <td width="300" class="o_btn o_bg-white o_br o_heading o_text" align="center"
                          ...
                          <a class="o_text-primary" href="{{ route('dispute.single', ['id' => $dispute->id]) }}"
                ...
                <td class="o_re o_bg-white o_px o_pb-md" align="center"
                  ...
                  <div class="o_col o_col-3 o_col-full"
                    ...
                    <div class="o_px-xs o_sans o_text-xs o_text-secondary o_left o_xs-left"
                      ...
                      <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 8px;"><strong>Project Details</strong>
                      </p>
                      <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">
                        ...
                        <strong>Total Milestones:</strong> {{ $project->milestone->count() }} Milestones<br>
                      </p>
                      ...
                      <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;"> <strong>Dispute ID:</strong>
                        #{{ $dispute->id }}<br>
                        <strong>Dispute Requested:</strong> {{ $dispute->created_at->format('H:i j/n/Y') }}<br>
                  ...
                  <div class="o_col o_col-3 o_col-full"
                    ...
                    <div class="o_px-xs o_sans o_text-xs o_text-secondary o_left o_xs-left"
                      ...
                      <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 8px;"><strong>Alchemist
                          Gain:[TODO]</strong></p>
                      <p style="margin-top: 0px;margin-bottom: 0px;">1/5 Votes (20%)&nbsp; &nbsp; &nbsp; &nbsp;= Gain
                        <span><strong>$60&nbsp;USD</strong></span></p>
                      <p style="margin-top: 0px;margin-bottom: 0px;">2/5 Votes (40%)&nbsp; &nbsp; &nbsp; &nbsp;= Gain
                        <span><strong>$120&nbsp;USD</strong></span></p>
                      <p style="margin-top: 0px;margin-bottom: 0px;">3/5 Votes (60%)&nbsp; &nbsp; &nbsp; &nbsp;= Gain
                        <span><strong>$180&nbsp;USD</strong></span></p>
                      <p style="margin-top: 0px;margin-bottom: 0px;color: #86AC00">4/5 Votes (80%)&nbsp; &nbsp; &nbsp;
                        &nbsp;= Gain <span><strong>$240&nbsp;USD</strong></span></p>
                      <p style="margin-top: 0px;margin-bottom: 0px;">5/5 Votes (100%)&nbsp; &nbsp; &nbsp;= Gain
                        <strong>$300&nbsp;USD</strong></span></p>

                      <p style="margin-top: 0px;margin-bottom: 5px;">--------------------</p>

                      <p style="margin-top: 0px;margin-bottom: 24px;">Credits Returned&nbsp; &nbsp; &nbsp; = <span>15
                        </span>Credits</p>
                      <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 8px;"><strong>Seeker
                          Payout:[TODO]</strong></p>
                      <p style="margin-top: 0px;margin-bottom: 0px;">0/5 Votes (0%)&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;=
                        Pay <span><strong>$300 USD</strong></span></p>
                      <p style="margin-top: 0px;margin-bottom: 0px;color: #C00000">1/5 Votes (20%)&nbsp; &nbsp; &nbsp;
                        &nbsp;= Pay <span><strong>$240&nbsp;USD</strong></span></p>
                      <p style="margin-top: 0px;margin-bottom: 0px;">2/5 Votes (40%)&nbsp; &nbsp; &nbsp; &nbsp;= Pay
                        <span><strong>$180&nbsp;USD</strong></span></p>
                      <p style="margin-top: 0px;margin-bottom: 0px;">3/5 Votes (60%)&nbsp; &nbsp; &nbsp; &nbsp;= Pay
                        <span><strong>$120&nbsp;USD</strong></span></p>
                      <p style="margin-top: 0px;margin-bottom: 0px;">4/5 Votes (80%)&nbsp; &nbsp; &nbsp; &nbsp;= Pay
                        <span><strong>$60&nbsp;USD</strong></span></p>
                      <p style="margin-top: 0px;margin-bottom: 5px;">5/5 Votes (100%)&nbsp; &nbsp; &nbsp;= Pay
                        <span><strong>$0&nbsp;USD</strong></span></p>
                      <p style="margin-top: 0px;margin-bottom: 5px;">--------------------</p>

                      <p style="margin-top: 0px;margin-bottom: 24px;">Credits Returned&nbsp; &nbsp; &nbsp; = <span>0
                        </span>Credits</p>
                    </div>
                  </div>
            ...
            <tbody>
              <tr>
                <td class="o_re o_bg-primary o_px o_pb-md" align="center"
                  style="font-size: 0;vertical-align: top;background-color: #FF0303;padding-left: 16px;padding-right: 16px;padding-bottom: 24px;">
                  ...
                  <div class="o_col o_col-4 o_col-full"
                    ...
                    <div class="o_px-xs o_sans o_text o_text-white o_left o_xs-center"
                      ...
                      <h3 class="o_heading o_mb-xxs"
                        ...
                        Seeker Dispute Invoice #21554[TODO: eveyrthing here]</h3>
                      <p style="margin-top: 0px;margin-bottom: 0px;">80% Of $300 USD</p>
                    </div>
                  </div>
                  ...
                  <div class="o_col o_col-2 o_col-full"
                    ...
                    <div class="o_px-xs o_sans o_text o_text-white o_right o_xs-center"
                      ...
                      <h3 class="o_heading o_mb-xxs"
                        style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;font-size: 24px;line-height: 31px;">
                        $240 USD</h3>
                      <p style="margin-top: 0px;margin-bottom: 0px;"><strong>Total Sent</strong></p>
                    </div>
                  </div>
                  <!--[if mso]></td></tr></table><![endif]-->
                </td>
            ...
            <tbody>
              <tr>
                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                  ...
                  <p style="margin-top: 0px;margin-bottom: 0px;">Thank you {{ $sender->full_name }}.</p>
                </td>
              </tr>
            </tbody>
          </table>
