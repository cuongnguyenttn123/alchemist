                            ...
                            <tr>
                                <td class="o_bg-primary o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-white"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="o_sans o_text o_text-white o_b-white o_px o_py o_br-max"
                                                    ...
                                                    <img src="{{ asset('public/assets/images/email/dispute/check-48-white.png') }}"
                                    ...
                                    <h2 class="o_heading o_mb-xxs"
                                        ...
                                        Dispute Request Accepted!</h2>
                                    <p style="margin-top: 0px;margin-bottom: 20px;">Hi
                                        <span>{{ $sender->full_name }}</span>, Your request
                                        to enter a dispute with {{ $receiver->full_name }} has been accepted! Please
                                        review your dispute
                                        details below:</p>
