...
<body class="o_body o_bg-light"
                            ...
                            <tr>
                                <td class="o_bg-primary o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-white"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="o_sans o_text o_text-white o_b-white o_px o_py o_br-max"
                                                    ...
                                                    <img src="{{ asset('public/assets/images/email/dispute/team.png') }}"
                                    ...
                                    <h2 class="o_heading o_mb-xxs"
                                        ...
                                        All Arbiters Accepted!</h2>
                                    <p style="margin-top: 0px;margin-bottom: 20px;">Hi
                                        <span>{{ $receiver->full_name }}</span>,
                                        all invited arbiters have accepted and will be sending their case and decision!
                                    </p>
    ...
    @include('emails.dispute.partials.dispute-details')

    @include('emails.dispute.partials.disputed-milestone')
