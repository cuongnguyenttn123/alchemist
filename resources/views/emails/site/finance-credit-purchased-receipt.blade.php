              ...
              <tr>
                <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center"
                    ...
                    <tbody>
                      <tr>
                        <td class="o_sans o_text o_text-secondary o_b-primary o_px o_py o_br-max" align="center"
                          ...
                          <img src="{{ asset('public/assets/images/email/site/credit.png') }}" width="96" height="96"
                            alt=""
                  ...
                  <h2 class="o_heading o_text-dark o_mb-xxs"
                    ...
                    Credit Purchased</h2>
                  <p style="margin-top: 0px;margin-bottom: 0px;">Hi <span>{{ $user->full_name }}</span>, you have
                    successfully
                    purchased crafting credit to create projects and contests.</p>
                </td>
              </tr>
            </tbody>
          </table>
            ...
            <tbody>
              <tr>
                <td class="o_bg-white o_sans o_text-xs o_text-light o_px-md o_pt-xs" align="center"
                  ...
                  <p style="margin-top: 0px;margin-bottom: 0px;">Credit Purchased</p>
                  <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                    <tbody>
                      <tr>
                ...
                <td class="o_re o_bg-white o_px o_pt-xs o_hide-xs" align="center"
                  ...
                  <div class="o_col o_col-1"
                    ...
                    <div class="o_px-xs o_sans o_text-xs o_right"
                      ...
                      <p class="o_text-light" style="color: #82899a;margin-top: 0px;margin-bottom: 0px;">Credit</p>
                    </div>
                  </div>
                ...
                <td class="o_re o_bg-white o_px o_pt" align="center"
                  ...
                  <div class="o_col o_col-3 o_col-full"
                    ...
                    <div class="o_px-xs o_sans o_text-xs o_left"
                      ...
                      <p class="o_text o_text-secondary"
                        ...
                        <strong>
                          @if($credit->payment_method === 'wallet')
                          Wallet
                          @else
                          PayPal
                          @endif
                  ...
                  <div class="o_col o_col-1 o_col-full"
                    ...
                    <div class="o_px-xs o_sans o_text o_center o_xs-left"
                      style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 13px;line-height: 24px;text-align: center;padding-left: 8px;padding-right: 8px;">
                      <p class="o_text-secondary" style="color: #424651;margin-top: 0px;margin-bottom: 0px;"><span
                          class="o_hide-lg"
                          style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;">Time:&nbsp;
                        </span>{{ $credit->created_at->format('h:i a') }}</p>
                    </div>
                  </div>
                  ...
                  <div class="o_col o_col-1 o_col-full"
                    ...
                    <div class="o_px-xs o_sans o_text o_center o_xs-left"
                      ...
                      <p class="o_text-secondary" style="color: #424651;margin-top: 0px;margin-bottom: 0px;"><span
                          class="o_hide-lg"
                          style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;">Date:&nbsp;
                        </span>{{ $credit->created_at->format('j/n/Y') }}</p>
                    </div>
                  </div>
                  <!--[if mso]></td><td width="100" align="center" valign="top" style="padding: 0px 8px;"><![endif]-->
                  <div class="o_col o_col-1 o_col-full"
                    ...
                    <div class="o_px-xs o_sans o_text o_center o_xs-left"
                      ...
                      <p class="o_text-secondary" style="color: #424651;margin-top: 0px;margin-bottom: 0px;"><span
                        ...
                        </span>{{ formatMoney($credit->value) }}</p>
                    </div>
                  </div>
                  <!--[if mso]></td><td width="100" align="right" valign="top" style="padding: 0px 8px;"><![endif]-->
                  <div class="o_col o_col-1 o_col-full"
                    ...
                    <div class="o_px-xs o_sans o_text o_right o_xs-left"
                      style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 13px;line-height: 24px;text-align: right;padding-left: 8px;padding-right: 8px;">
                      <p class="o_text-secondary" style="color: #424651;margin-top: 0px;margin-bottom: 0px;"><span
                          class="o_hide-lg"
                          style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;">Credit:&nbsp;
                        </span>{{ number_format($credit->exchange_value, 0, '.', ',') }}</p>
                    </div>
                  </div>
                  <!--[if mso]></td></tr><tr><td colspan="4" style="padding: 0px 8px;"><![endif]-->
                  <div class="o_px-xs" style="padding-left: 8px;padding-right: 8px;">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td width="50%" class="o_pt-xs" align="right" style="padding-top: 8px;">
                                  <p class="o_sans o_text o_text-secondary"
                                    style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;color: #424651;">
                                    {{ number_format($purchased_credit, 0, '.', ',') }} CRT</p>
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td width="50%" class="o_pt" align="right" style="padding-top: 16px;">
                                  <p class="o_sans o_text o_text-primary"
                                    ...
                                    <strong>{{$total_credit}} CRT</strong></p>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                    ...
                    <tbody>
                      <tr>
                        <td width="300" class="o_btn o_bg-success o_br o_heading o_text" align="center"
                          ...
                          <a class="o_text-white" href="{{ route('email.site.print-reciept') }}"
                            style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Print
                            Receipt</a>
                        </td>
                      </tr>
                    </tbody>
