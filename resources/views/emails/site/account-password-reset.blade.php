              ...
              <tr>
                <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center"
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                      <tr>
                        <td class="o_bb-primary" height="40" width="32" style="border-bottom: 1px solid #126de5;">&nbsp;
                        </td>
                        <td rowspan="2" class="o_sans o_text o_text-secondary o_px o_py" align="center"
                          ...
                          <img src="{{ asset('public/assets/images/email/site/vpn_key-48-primary.png') }}" width="48"
                            height="48" alt=""
                  ...
                  <p style="margin-top: 0px;margin-bottom: 0px;">Hi <span>{{ $user->full_name }}</span>, have you
                    forgotten your
                    password? If this was'nt you then please ignore this email.</p>
                </td>
              </tr>
            </tbody>
          </table>
                    ...
                    <tbody>
                      <tr>
                        <td width="300" class="o_btn o_bg-primary o_br o_heading o_text" align="center"
                          ...
                          <a class="o_text-white" href="{{$link}}"
        ...
        <td class="o_bg-light o_px-xs" align="center"
          ...
          <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
            ...
            <tbody>
              <tr>
                <td class="o_bg-white"
                  style="font-size: 48px;line-height: 28px;height: 28px;background-color: #ffffff;">&nbsp; </td>
              </tr>
            </tbody>
          </table>
          <!--[if mso]></td></tr></table><![endif]-->
