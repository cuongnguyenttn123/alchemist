    ...
    <tr>
      <td class="o_bg-light o_px-xs o_pb-lg o_xs-pb-xs" align="center"
        ...
        <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
          ...
          <tbody>
            <tr>
              <td class="o_bg-white o_br-b o_sans"
                style="font-size: 8px;line-height: 8px;height: 8px;font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;background-color: #ffffff;border-radius: 0px 0px 4px 4px;">
                &nbsp; </td>
            </tr>
            <tr>
              <td class="o_re o_px o_pb-lg" align="center"
                style="font-size: 0;vertical-align: top;padding-left: 16px;padding-right: 16px;padding-bottom: 32px;">
                ...
                <div class="o_col o_col-4"
                  ...
                  <div class="o_px-xs o_sans o_text-xs o_text-light o_left o_xs-center"
                    ...
                    <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 8px;">©2019 Alchemuntiy LTD. All rights
                      reserved.</p>

                    <p style="margin-top: 0px;margin-bottom: 0px;">
                      <br class="o_hide-lg"
                        style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;">
                      <a class="o_text-light o_underline" href="{{ route('home') }}"
                        style="text-decoration: underline;outline: none;color: #82899a;">Home</a> <span
                        class="o_hide-xs">&nbsp; • &nbsp;</span><br class="o_hide-lg"
                        style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;">
                      <a class="o_text-light o_underline" href="{{ route('home') }}"
                        style="text-decoration: underline;outline: none;color: #82899a;">Login</a>
                    </p>
                  </div>
                </div>
                ...
                <div class="o_col o_col-2"
                  ...
                  <div class="o_px-xs o_sans o_text-xs o_text-light o_right o_xs-center"
                    ...
                    <p style="margin-top: 0px;margin-bottom: 0px;">
                      <a class="o_text-light" href="https://www.facebook.com/Alchemunity-105742580853775/"
                        style="text-decoration: none;outline: none;color: #82899a;"><img
                          src="{{ asset('public/assets/images/email/site/facebook-light.png') }}" width="72" height="72"
                          alt="fb"
                        ...
                        &nbsp;</span>
                      <a class="o_text-light" href="https://www.linkedin.com/company/alchemunity/"
                        style="text-decoration: none;outline: none;color: #82899a;"><img
                          src="{{ asset('public/assets/images/email/site/linkedin.png') }}" width="72" height="72"
                          alt="LinkedIn"
                          style="max-width: 36px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a><span>
                        &nbsp;</span>
                    </p>
