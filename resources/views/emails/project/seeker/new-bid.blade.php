              ...
              <tr>
                <td class="o_bg-primary o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-white" align="center"
                    ...
                    <tbody>
                      <tr>
                        <td class="o_sans o_text o_text-white o_b-white o_px o_py o_br-max" align="center"
                          ...
                          <img src="{{ asset('public/assets/images/email/project/bid-white.png') }}" width="96"
                            height="96" alt=""
                  ...
                  <h2 class="o_heading o_mb-xxs"
                    ...
                    You Have a New Project Bid!</h2>
                  <p style="margin-top: 0px;margin-bottom: 20px;">Hi <span>{{ $seeker->full_name }}</span>, you have
                    just received a
                    new bid on your project!</p>
                      ...
                      <tr>
                        <td width="300" class="o_btn o_bg-white o_br o_heading o_text" align="center"
                          ...
                          <a class="o_text-primary"
                            href="{{ route('profile.projectBids', ['slug' => Illuminate\Support\Str::slug($project->name), 'id' => $project->id]) }}"
                            style="text-decoration: none;outline: none;color: #126de5;display: block;padding: 12px 24px;mso-text-raise: 3px;">View
                            Bid &nbsp;→</a>
                        </td>
                      </tr>
                    </tbody>
                ...
                <td class="o_bg-white o_px-md o_py-md o_sans o_text o_text-secondary" align="left"
                  ...
                  <div class=" o_text o_text-secondary " style="display: inline-block;vertical-align: top;width: 100%;">
                      ...
                      <tbody>
                        <tr>
                          <td width="48" class="o_bb-light o_text-md o_text-secondary o_sans o_py" align="right"
                            ...
                            <img class="o_br-max" src="{{ $seeker->avatar }}" width="96" height="96" alt=""
                              style="max-width: 43px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;border-radius: 96px;">
                          </td>
                    ...
                    <div class="o_px-xs o_sans o_text o_text-secondary o_left "
                      ...
                      <p class="o_text o_text-secondary" style="margin-top: 0px;margin-bottom: 4px;"><strong>Project ID:
                          {{ $project->id }}</strong> <span class="o_text o_text-secondary"
                          style="font-size: 12px;line-height: 19px;">({{ $project->milestone->sum('workday') }}
                          days / {{ formatMoney($project->milestone->sum('price')) }})</span></p>
                      ...
                      <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 5px;">{{ $project->detail_description }}
                      </p>
                    </div>
                  </div>
              ...
              <tr>
                <td class="o_bg-white o_px-md o_py-md o_sans o_text o_text-secondary" align="left"
                  ...
                  <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                    <tbody>
                      <tr>
                        <td width="48" class="o_bb-light o_text-md o_text-secondary o_sans o_py" align="right"
                          style="vertical-align: top;font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;color: #424651;border-bottom: 1px solid #d3dce0;padding-top: 16px;padding-bottom: 16px;">
                          <img class="o_br-max" src="{{ $alchemist->avatar }}" width="96" height="96" alt=""
                        ...
                        <td class="o_bb-light o_text o_text-secondary o_sans o_px o_py" align="left"
                          style="vertical-align: top;font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;color: #424651;border-bottom: 1px solid #d3dce0;padding-left: 16px;padding-right: 16px;padding-top: 16px;padding-bottom: 16px;">
                          <p style="margin-top: 0px;margin-bottom: 0px;"><strong class="o_text-dark"
                              style="color: #242b3d;">{{ $alchemist->full_name }}</strong> <span
                              class="o_text-default o_text-xs" style="font-size: 14px;line-height: 21px;">&nbsp;<span
                                class="o_text-light" style="color: #8BDB02;">●&nbsp; </span>{{ $alchemist->user_title }}
                              | LV
                              {{ $alchemist->level }}</span></p>
                          <p class="o_text-xxs o_text-light"
                            style="font-size: 12px;line-height: 19px;color: #82899a;margin-top: 0px;margin-bottom: 0px;">
                            {{ $bid->created_at->format('h:ia, l, M j Y') }}</p>
                        </td>
                      </tr>
                    </tbody>
                  </table>
                  ...
                  <p class="o_text-primary" style="color: #126de5;margin-top: 0px;margin-bottom: 5px;">
                    <em>{{ $bid->skills->implode('name', ', ') }}</em></p>

                  @foreach($bid->filesCollection as $attachment)
                  <table cellspacing="0" cellpadding="0" border="0" role="presentation">
                      ...
                      <tr>
                        <td class="o_btn-b o_heading o_text-xs" align="center"
                          ...
                          <a class="o_text-primary" href="{{ url('public/' . $attachment->url) }}"
                            style="text-decoration: none;outline: none;color: #126de5;display: block;padding: 0px 8px 10px 0px;font-weight: bold;"
                            download>
                            <img src="{{ asset('public/assets/images/email/project/attachment-24.png') }}" width="24"
                              height="24" alt=""
                            ...
                            <span
                              style="mso-text-raise: 6px;display: inline;color: #126de5;">{{ $attachment->name }}</span>
                          </a>
                        </td>
                      </tr>
                    </tbody>
                ...
                <td class="o_re o_bg-white o_px o_pt" align="center"
                  ...
                  <div class="o_col o_col-4 o_col-full"
                    ...
                    <div class="o_px-xs o_sans o_text-xs o_left"
                      style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;text-align: left;padding-left: 8px;padding-right: 8px;">
                      <p class="o_text o_text-secondary"
                        style="font-size: 16px;line-height: 24px;color: #929292;margin-top: 0px;margin-bottom: 5px;">
                  ...
                  <div class="o_col o_col-1 o_col-full"
                    ...
                    <div class="o_px-xs o_sans o_text o_center o_xs-left"
                      ...
                      <p class="o_text-secondary" style="color: #424651;margin-top: 0px;margin-bottom: 0px;"><span
                          ...
                          Estimate:&nbsp; </span>{{ $milestone->workday }}</p>
                    </div>
                  </div>
                  <!--[if mso]></td><td width="100" align="right" valign="top" style="padding: 0px 8px;"><![endif]-->
                  <div class="o_col o_col-1 o_col-full"
                ...
                <td class="o_re o_bg-primary o_px o_pb-md" align="center"
                  ...
                  <div class="o_col o_col-4 o_col-full"
                    ...
                    <div class="o_px-xs o_sans o_text o_text-white o_left o_xs-center"
                      ...
                      <h3 class="o_heading o_mb-xxs"
                        style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;font-size: 24px;line-height: 31px;">
                        {{ $bid->milestones->sum('workday') }} Days / {{ $bid->milestones->count() }}
                        Milestones </h3>
                      <p style="margin-top: 0px;margin-bottom: 0px;">Estimated Delivery:
                        {{ \Carbon\Carbon::createFromTimestamp($project->deadline)->format('l, F j Y') }}</p>
                    </div>
                  </div>
                  ...
                  <div class="o_col o_col-2 o_col-full"
                    ...
                    <div style="font-size: 24px; line-height: 24px; height: 24px;">&nbsp; </div>
                    <div class="o_px-xs o_sans o_text o_text-white o_right o_xs-center"
                      style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;color: #ffffff;text-align: right;padding-left: 8px;padding-right: 8px;">
                      <h3 class="o_heading o_mb-xxs"
                        style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;font-size: 24px;line-height: 31px;">
                        {{ formatMoney($bid->milestones->sum('price')) }}</h3>
                      <p style="margin-top: 0px;margin-bottom: 0px;"><strong>Total Estimate</strong></p>
                    </div>
                  </div>
                  <!--[if mso]></td></tr></table><![endif]-->
                </td>
                          ...
                          <tr>
                            <td class="o_btn o_bg-dark o_br o_heading o_text" align="center"
                              ...
                              <a class="o_text-white"
                                href="{{ route('profile.projectBids', ['id' => $project->id, 'slug' => Illuminate\Support\Str::slug($project->name)]) }}"
                                style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Negotiate&nbsp;
                                💬</a>
                            </td>
                          </tr>
                        </tbody>
