            ...
            <tbody>
              <tr>
                <td class="o_bg-primary o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-white" align="center"
                  style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #6BD300;color: #ffffff;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px;">
                    ...
                    <tbody>
                      <tr>
                        <td class="o_sans o_text o_text-white o_b-white o_px o_py o_br-max" align="center"
                          ...
                          <img src="{{ asset('public/assets/images/email/project/check-48-white.png') }}" width="96"
                            height="96" alt=""
                  ...
                  <h2 class="o_heading o_mb-xxs"
                    ...
                    Your Bid Was Accepted!</h2>
                  <p style="margin-top: 0px;margin-bottom: 20px;">Hi <span>{{ $alchemist->full_name }}</span>,
                    {{ $seeker->full_name }} Has Accepted your Bid!</p>
                      ...
                      <tr>
                        ...
                        <td class="o_bb-light o_text o_text-secondary o_sans o_px o_py" align="left"
                          ...
                          <p style="margin-top: 0px;margin-bottom: 0px;"><strong class="o_text-dark"
                              ...
                              {{ sprintf('%02d', $seeker->user_tier()) }} | LV {{ $seeker->level }}</span></p>
                ...
                <td class="o_bg-white o_px-md o_py-md o_sans o_text o_text-secondary" align="left"
                  ...
                  <div class=" o_text o_text-secondary " style="display: inline-block;vertical-align: top;width: 100%;">
                    ...
                    <div class="o_px-xs o_sans o_text o_text-secondary o_left "
                      ...
                      <p class="o_text o_text-secondary" style="margin-top: 0px;margin-bottom: 4px;color: #126DE5">
                        <strong>Accepted Your Bid: </strong></p>
                      ...
                      <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 5px;">{{ $bid->description }}</p>
                ...
                <td class="o_re o_bg-primary o_px o_pb-md" align="center"
                  ...
                  <div class="o_col o_col-4 o_col-full"
                    ...
                    <div class="o_px-xs o_sans o_text o_text-white o_left o_xs-center"
                      ...
                      <h3 class="o_heading o_mb-xxs"
                        ...
                        {{ $bid->milestones->pluck('workday')->sum() }} Days /
                        {{ $bid->milestones->count() }} Milestones </h3>
                  ...
                  <div class="o_col o_col-2 o_col-full"
                    ...
                    <div class="o_px-xs o_sans o_text o_text-white o_right o_xs-center"
                      ...
                      <p style="margin-top: 0px;margin-bottom: 0px;"><strong>Accepted Total</strong></p>
                    </div>
                  </div>
                  <!--[if mso]></td></tr></table><![endif]-->
                </td>
                        ...
                        <tbody>
                          <tr>
                            <td class="o_btn o_bg-dark o_br o_heading o_text" align="center"
                              style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: #F9140E;border-radius: 4px;">
                              <a class="o_text-white"
                                href="{{ route('profile.projectBids', ['slug' => Illuminate\Support\Str::slug($project->name, '-'), 'id' => $project->id]) }}"
                                style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Reject
                                Project Offer</a>
                            </td>
                          </tr>
                        </tbody>
