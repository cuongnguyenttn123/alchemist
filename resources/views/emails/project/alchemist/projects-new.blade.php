              ...
              <tr>
                <td class="o_bg-primary o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-white" align="center"
                    ...
                    <tbody>
                      <tr>
                        <td class="o_sans o_text o_text-white o_b-white o_px o_py o_br-max" align="center"
                          ...
                          <img src="{{ asset('public/assets/images/email/project/briefcase-48-white.png') }}" width="96"
                            height="96" alt=""
                  ...
                  <h2 class="o_heading o_mb-xxs"
                    ...
                    New Projects Available!</h2>
                  <p style="margin-top: 0px;margin-bottom: 0px;">Hi <span>{{ $user->full_name }},</span> here are the
                    latest jobs matching your skills.</p>
                </td>
              </tr>
            </tbody>
          </table>
                ...
                <td class="o_re o_bg-white o_px o_pt-xs o_hide-xs" align="center"
                  ...
                  <div class="o_col o_col-4"
                    ...
                    <div class="o_px-xs o_sans o_text-xs o_left"
                      ...
                      <p class="o_text-light" style="color: #82899a;margin-top: 0px;margin-bottom: 0px;">Projects</p>
                    </div>
                  </div>
                ...
                <td class="o_re o_bg-white o_px o_pt" align="center"
                  ...
                  <div class="o_col o_col-4 o_col-full"
                    ...
                    <div class="o_px-xs o_sans o_text-xs o_left"
                      ...
                      @if($project->listtype->pluck('type_name')->contains('Featured'))
                      ...
                      @endif
                      @if($project->listtype->pluck('type_name')->contains('Urgent'))
                      <div class="o_col_i" style="display: inline-block;vertical-align: top;">
                        <div class="o_px-xs" style="padding-left: 0px;padding-right: 8px;margin-bottom: 5px">
                          <table align="center" cellspacing="0" cellpadding="0" border="0" role="presentation">
                            <tbody>
                              <tr>
                                <td class="o_btn o_bg-primary o_br o_heading o_text" align="center"
                                  style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 10px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: #FF9100;border-radius: 4px;">
                                  <span class="o_text-white" href="#"
                                    style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 2px 11px;mso-text-raise: 3px;">URGENT</span>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                      ...
                      <p class="o_text-primary" style="color: #8289A0;margin-top: 0px;margin-bottom: 0px;"><em>Delivery
                          Target: {{ \Carbon\Carbon::createFromTimestamp($project->deadline)->format('jS F Y') }} </em>
                      </p>
                              ...
                              <tbody>
                                <tr>
                                  <td class="o_btn o_bg-primary o_br o_heading o_text" align="center"
                                    ...
                                    <a class="o_text-white" href="{{ route('jobdetail', ['id' => $project->id]) }}"
                                      style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 5px 15px;mso-text-raise: 3px;">BID
                                      NOW</a>
                                  </td>
                                </tr>
                              </tbody>
                  ...
                  <div class="o_col o_col-1 o_col-full"
                    ...
                    <div class="o_px-xs o_sans o_text o_center o_xs-left"
                      ...
                      <p class="o_text-secondary" style="color: #424651;margin-top: 0px;margin-bottom: 0px;"><span
                          ...
                          Estimate:&nbsp;
                        </span>{{ \Carbon\Carbon::createFromTimeStamp($project->deadline)->diffInDays(now()) }}</p>
                    </div>
                  </div>
                  <!--[if mso]></td><td width="100" align="right" valign="top" style="padding: 0px 8px;"><![endif]-->
                  <div class="o_col o_col-1 o_col-full"
                    ...
                    <div class="o_px-xs o_sans o_text o_right o_xs-left"
                      ...
                      <p class="o_text-secondary" style="color: #424651;margin-top: 0px;margin-bottom: 0px;"><span
                        ...
                        </span>{{ formatMoney($project->budget) }}</p>
                    </div>
                  </div>
                    ...
                    <tbody>
                      <tr>
                        <td width="300" class="o_btn o_bg-dark o_br o_heading o_text" align="center"
                          ...
                          <a class="o_text-white" href="{{ route('search') }}"
