              ...
              <tr>
                <td class="o_bg-primary o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-white" align="center"
                    ...
                    <tbody>
                      <tr>
                        <td class="o_sans o_text o_text-white o_b-white o_px o_py o_br-max" align="center"
                          ...
                          <img src="{{ asset('public/assets/images/email/project/star-48-white.png') }}" width="96"
                            height="96" alt=""
                  ...
                  <h2 class="o_heading o_mb-xxs"
                    ...
                    Project Has Been Completed! </h2>
                  <h2 class="o_heading o_mb-xxs"
                    style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;font-size: 30px;line-height: 39px;">
                    Please leave a Review!</h2>
                  <p style="margin-top: 0px;margin-bottom: 20px;">Hi <span>{{ $user_from->full_name }}</span>, please
                    leave a review for {{ $user_to->full_name }} and help others find out
                    their{{ $isForSeeker ? ' Seeker' : '' }} potential!</p>
                </td>
              </tr>
            </tbody>
          </table>
                  ...
                  <div class=" o_text o_text-secondary " style="display: inline-block;vertical-align: top;width: 100%;">
                    ...
                    <div class="o_px-xs o_sans o_text o_text-secondary o_left "
                      ...
                      <p class="o_text o_text-secondary" style="margin-top: 0px;margin-bottom: 4px;"><strong>Project ID:
                          ...
                          style="font-size: 12px;line-height: 19px;">({{ $project->accepted_milestones->sum('workday') }}
                          days /
                          {{ formatMoney($project->accepted_milestones->sum('price')) }})</span></p>
                    ...
                    <tbody>
                      <tr>
                        <td width="48" class="o_bb-light o_text-md o_text-secondary o_sans o_py" align="right"
                          ...
                          <img class="o_br-max" src="{{ $user_to->avatar }}" width="96" height="96" alt=""
                    ...
                    <tbody>
                      <tr>
                        <td width="300" class="o_btn o_bg-primary o_br o_heading o_text" align="center"
                          style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: #74C800;border-radius: 4px;">
                          <a class="o_text-white"
                            href="{{ route('profile.tracking', ['id' => $project->id, 'slug' => Illuminate\Support\Str::slug($project->name)]) }}"
                            style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Write
                            {{ $user_to->first_name }}'s Review&nbsp;★</a>
                        </td>
                      </tr>
                    </tbody>
                  </table>
