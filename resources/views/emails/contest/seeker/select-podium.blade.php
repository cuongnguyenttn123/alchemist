              ...
              <tr>
                <td class="o_bg-primary o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-white" align="center"
                    ...
                    <tbody>
                      <tr>
                        <td class="o_sans o_text o_text-white o_b-white o_px o_py o_br-max" align="center"
                          ...
                          <img src="{{ asset('public/assets/images/email/contest/Podium-white.png') }}" width="96"
                            height="96" alt=""
                  ...
                  <h2 class="o_heading o_mb-xxs"
                    ...
                    It's Time to Select a Winner!</h2>
                  <p style="margin-top: 0px;margin-bottom: 20px;">Hi <span>{{ $user->full_name }}</span>, your contest
                    has just been wrapped up. You must select your 1st, 2nd, 3rd &amp; 4th place to receive your files!
                  </p>
