              ...
              <tr>
                <td class="o_bg-primary o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-white" align="center"
                  ...
                  <h2 class="o_heading o_mb-xxs"
                    ...
                    New Contest Entry!</h2>
                  <p style="margin-top: 0px;margin-bottom: 20px;">Hi <span>{{ $user->full_name }}</span>, you have just
                    received a new entry for your contest!</p>
              ...
              <tr>
                <td class="o_bg-white o_px-md o_py-md o_sans o_text o_text-secondary" align="left"
                    ...
                    <tbody>
                      <tr>
                        <td width="48" class="o_bb-light o_text-md o_text-secondary o_sans o_py" align="right"
                          ...
                          <img class="o_br-max" src="{{ $new_entry->user->avatar }}" width="96" height="96" alt=""
                  ...
                  <p class="o_text o_text-secondary"
                    ...
                    <strong>{{ $new_entry->title }}</strong></p>
                  <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 5px;">{{ $new_entry->description }}</p>
                  <p class="o_text-primary" style="color: #8289A0;margin-top: 0px;margin-bottom: 5px;"><em>Preview Entry
                      Files:</em></p>

                  @foreach($new_entry->preview_attachments() as $attachment)
                  <table cellspacing="0" cellpadding="0" border="0" role="presentation">
                    <tbody>
                      <tr>
