              ...
              <tr>
                <td class="o_bg-primary o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-white" align="center"
                  ...
                  <h2 class="o_heading o_mb-xxs"
                    ...
                    Contest Winner!</h2>
                  <p style="margin-top: 0px;margin-bottom: 20px;">Hi <span>{{ $winner->user->full_name }}</span>, you have
                    placed 1st in {{ $contest->user->full_name }}'s Contest. Please view your payment confirmation &amp;
                    podium results!</p>
            ...
            <tbody>
              <tr>
                <td class="o_bg-white o_px-md o_py-md o_sans o_text o_text-secondary" align="left"
                  ...
                  <p class="o_text-primary" style="color: #8289A0;margin-top: 0px;margin-bottom: 5px;"><em>Sent
                      Files:</em></p>
                        ...
                        <td class="o_btn-b o_heading o_text-xs" align="center"
                          ...
                          <a class="o_text-primary" href="{{ url('public/' . $attachment->url) }}"
                            style="text-decoration: none;outline: none;color: #126de5;display: block;padding: 0px 8px 0px 0px;font-weight: bold;"><img
                              src="{{ asset('public/' . $attachment->url) }}" width="24" height="24" alt=""
                              ...
                              <tr>
                                ...
                                <td width="50%" class="o_pt" align="right" style="padding-top: 16px;">
                                  <p class="o_sans o_text o_text-primary"
                                    ...
                                    <strong>{{ App\Libs\Calculator::contestPointEarn($winner->user->user_title, 1) }}
                                      SBP</strong></p>
                                </td>
                              </tr>
                              <tr>
                  ...
                  <div class="o_col o_col-4 o_col-full"
                    ...
                    <div class="o_px-xs o_sans o_text-xs o_left"
                      ...
                      <p class="o_text o_text-secondary"
                        ...
                        @if($winner->user->id == $entrie->user->id)
                        <strong class="o_text-dark" style="color: #88C000;">You Won</strong><strong> |
                          {{ $entrie->user->full_name }}</strong>
                        @else
                        <strong> {{ $entrie->user->full_name }}</strong>
                        @endif
                      </p>
                    </div>
                  </div>
