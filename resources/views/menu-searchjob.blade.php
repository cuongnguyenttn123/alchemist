...
<div id="accordion" role="tablist" aria-multiselectable="true">
  <div class="card">
    <div class="card-header" role="tab" id="headingOne-2" style="background-image: linear-gradient(#FFFFFF, #FAFBFD)">
      <h6 class="mb-0">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne-2-{{$screen}}" aria-expanded="true"
...
<div id="accordion" role="tablist" aria-multiselectable="true">
  <div class="card">
    <div class="card-header" role="tab" id="headingOne-3" style="background-image: linear-gradient(#FFFFFF, #FAFBFD)">
      <h6 class="mb-0">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne-3-{{$screen}}" aria-expanded="true"
           aria-controls="collapseOne-3"><img src="svg-icons/sprites/star-icon.svg" width="15" hspace="1"
                                              style="PADDING-BOTTOM: 3px; margin-left: 2px">
          <span style="color: #515380; padding-bottom: 5px; font-weight: 400; color: #858AA6">Project Type</span>
          <svg class="olymp-dropdown-arrow-icon">
            <use xlink:href="svg-icons/sprites/icons.svg#olymp-dropdown-arrow-icon"></use>
          </svg>
        </a>
    ...
    <div id="collapseOne-3-{{$screen}}" class="collapse " role="tabpanel" aria-labelledby="headingOne-3">
      <ul class="your-profile-menu" style="padding-bottom: 0px">
        @foreach($list_type as $type)
          <?php $checked = (isset($_GET['list_type']) && is_array($_GET['list_type']) && in_array($type->id, $_GET['list_type'])) ? 'checked' : '';?>
          <li>
            <div class="checkbox">
              <label>
                <input type="checkbox" name="list_type[]" value="{{$type->id}}" {{$checked}}>
                {{$type->type_name}}
              </label>
            </div>
          </li>
...
<div id="accordion" role="tablist" aria-multiselectable="true">
  <div class="card">
    <div class="card-header" role="tab" id="headingOne-4" style="background-image: linear-gradient(#FFFFFF, #FAFBFD)">
      <h6 class="mb-0">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne-4-{{$screen}}" aria-expanded="true"
    ...
    <div id="collapseOne-4-{{$screen}}" class="collapse " role="tabpanel" aria-labelledby="headingOne-4">
      <div class="search_price"
        ...
        <div class="price-range">
          ...
          <input style="float: right;" placeholder="Max" class="none_arrow" type="number" name="maxprice"
...
<div id="accordion" role="tablist" aria-multiselectable="true">
  <div class="card">
    <div class="card-header" role="tab" id="headingOne-5" style="background-image: linear-gradient(#FFFFFF, #FAFBFD)">
      <h6 class="mb-0">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne-5-{{$screen}}" aria-expanded="true"
...
<div id="accordion" role="tablist" aria-multiselectable="true">
  <div class="card">
    <div class="card-header" role="tab" id="headingOne-5" style="background-image: linear-gradient(#FFFFFF, #FAFBFD)">
      <h6 class="mb-0">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne-6-{{$screen}}" aria-expanded="true"
        ...
        <li style="padding-bottom: 10px;">
          <select class="selectize" name="language[]" multiple="multiple">
            ...
            @foreach($list_language as $language)
              <?php $selected = (isset($_GET['language']) && is_array($_GET['language']) && in_array($language->id, $_GET['language'])) ? 'selected' : '';?>
