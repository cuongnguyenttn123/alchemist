                ...
                <div class="body">
                    <form id="basic-form" action="{{ route("admin.project.update") }}" method="post">
                        ...
                        <div class="form-group border border-light rounded p-1">
                            <label>Name</label>
                                <input type="text" name="name" class="form-control" value="{{isset($project->name)?$project->name:""}}">
                        </div>
                        {{-- ====Short description==== --}}
                        <div class="form-group border border-light rounded p-1">
                            <label>Short description</label>
                            <textarea class="form-control" name="short_description" rows="3" cols="30">{{isset($project->short_description)?$project->short_description:""}}</textarea>
                        </div>
                        {{--  ====Description====  --}}
                        <input type="hidden" name="detail_description">
                        <div class="form-group border border-light rounded p-1">
                            <label>Description</label>
                            <textarea name="detail_description" class="summernote">{{isset($project->detail_description)?$project->detail_description:""}}</textarea>
                        </div>
                        {{--  ====Budget====  --}}
                        <div class="form-group border border-light rounded p-1">
                            <label>Budget ($)</label>
                            <input type="number" name="budget" min="0" class="form-control" value="{{isset($project->budget)?$project->budget:""}}">
                        </div>
                        {{--  ====Deadline====  --}}
                        <div class="form-group border border-light rounded p-1">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <input class="project-deadline form-control" type="text" name="deadline"
                                               data-date-autoclose="true" class="form-control" value="{{isset($project->deadline)?$project->deadline:""}}">
                                    </div>
                                </div>
                                <div class="col-md-9">
                                    <label>Biding time</label>
                                    <div class="input-daterange input-group" data-provide="datepicker">
                                        <input id="startbid" type="text" class="input-sm form-control" name="bid_start" value="{{isset($project->bid_start)?$project->bid_start:""}}">
                                        <span class="input-group-addon ml-1 mr-1"> to </span>
                                        <input id="endbid" type="text" class="input-sm form-control" name="bid_end" value="{{isset($project->bid_end)?$project->bid_end:""}}">
                                    </div>
                                </div>
                            </div>
                            {{--  Milestones  --}}
                            <div class="form-group border border-light rounded p-1">
                                <input type="hidden" name="milestones" value="{{isset($project->miles)?$project->miles:""}}">
                                <label for="">Milestones (?)</label>
                                <div class="p-5">
                                    <div class="row">
                                        <div class="col-md-12 p-2 border border-light rounded mile">
                                            @forelse($project->miles as $mile)
                                                <div class="mile-properties">
                                                    <div class="mile-name">
                                                        <label>Name</label>
                                                        <input type="text" data-name="mile_name"
                                                               class="form-control data-change-handle" readonly="readonly" value="{{$mile->title}}">
                                                    </div>
                                                    <div class="mile-des d-none">
                                                        <label>Description</label>
                                                        <textarea class="form-control data-change-handle" data-name="mile_description" rows="3" cols="30">{{$mile->description}}</textarea>
                                                    </div>
                                                    <div class="mile-time d-none">
                                                      <label for="">Work Day</label>
                                                      <div class="input-group">
                                                          <input type="number"
                                                                 class="input-sm form-control data-change-handle"
                                                                 data-name="mile_workday" min="0" value="{{ $mile->workday }}">
                                                      </div>
                                                    </div>
                                                    <div class="mile-perpay d-none">
                                                        <label>Percent payment</label>
                                                        <input type="number" min="0" data-name="mile_perpay"
                                                               class="form-control data-change-handle" value="{{$mile->percent_payment}}">
                                                    </div>
                                                    <div class="mile-content d-none">
                                                        <label>Content</label>
                                                        <textarea class="form-control data-change-handle"
                                                                  data-name="mile_content" rows="3" cols="30">{{$mile->content}}</textarea>
                                                    </div>
                                                    <div class="mile-show btn col-md-12 mt-1 bg-light text-center">
                                                        <i class="fas fa-angle-double-down"></i>
                                                    </div>
                                                    <div class="mile-hide btn col-md-12 mt-1 bg-light text-center d-none">
                                            ...
                                            <div class="mile-properties">
                                                ...
                                                <div class="mile-time">
                                                    ...
                                                    <div class="input-daterange input-group" data-provide="datepicker">
                                                        <input type="text"
                                                               class="input-sm form-control data-change-handle"
                                                               data-name="mile_time_start">
                                                        <span class="input-group-addon ml-1 mr-1"> to </span>
                                                        <input type="text"
                                                               class="input-sm form-control data-change-handle"
                                                               data-name="mile_time_end">
                                                    </div>
                                                </div>
                                ...
                                <div class="body ">
                                    <div class="input-group demo-tagsinput-area">
                                        <input
                                            ...
                                            value="@foreach($project->tags as $tag){{$tag->name}},@endforeach">
                                    </div>
                                </div>
                            </div>
                            {{-- Cateogries --}}
                            <div class="form-group border border-light rounded p-1">
                                ...
                                <select id="optgroup" class="ms  form-control" multiple="multiple" name="categories[]">
                                    @foreach($categories as $cate)
                                        <option value="{{ $cate->id }}" @if(in_array($cate->id, $project->categories)) selected @endif>{{ $cate->Current }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                                    ...
                                    <div class="form-contain">
                                        <select name="address_country"
                                            ...
                                            @foreach($countries as $country)
                                                <option value="{{ $country->id }}" @if($country->country == $project->locations->_curr->country) selected="selected" @endif>{{ $country->country }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-contain">
                                        <select name="address_state"
                                                ...
                                                @forelse($project->locations->states  as $state)
                                                    <option value="{{ $state->id }}" @if($state->state == $project->locations->_curr->state) selected="selected" @endif>{{ $state->state }}</option>
                                                @empty
                                ...
                                <div class="col-md-4 location">
                                    ...
                                    <div class="form-contain">
                                        <select name="address_city"
                                                ...
                                                single-selection">
                                                <option value="">none</option>
                                                @forelse($project->locations->cities  as $city)
                                                    <option value="{{ $city->id }}" @if($city->city == $project->locations->_curr->city) selected="selected" @endif>{{ $city->city }}</option>
                                                @empty
                        ...
                        <div class="form-group border border-light rounded p-1">
                            ...
                            <input type="hidden" name="questions" value="{{json_encode($project->questions)}}">
                            <div class="p-5">
                                <div class="row">
                                    <div class="col-md-12 border border-light rounded p-2">
                                      <div class="_questions">
                                          @forelse($project["questions"] as $question)

                                              <div class="_question">
                                                  <label>Question</label>
                                                  <textarea class="form-control question-change-hanlde" rows="3" cols="30" readonly="readonly" data-name="question">{{$question->question}}</textarea>
                                                  <div class="options d-none">
                                                      <label>Option A</label>
                                                      <input type="text" class="form-control question-change-hanlde" data-name="option_a" value="{{$question->option_a}}">
                                                      <label>Option B</label>
                                                      <input type="text" class="form-control question-change-hanlde" data-name="option_b" value="{{$question->option_b}}">
                                                      <label>Option C</label>
                                                      <input type="text" class="form-control question-change-hanlde" data-name="option_c" value="{{$question->option_c}}">
                                                      <label>Option D</label>
                                                      <input type="text" class="form-control question-change-hanlde" data-name="option_d" value="{{$question->option_d}}">
                                                      <label for="">Correct option</label>
                                                      <select class="form-control question-change-hanlde" data-name="correct_option" id="">
                                                          <option value="option_a" @if($question->correct_option == "option_a")selected @endif>Option A</option>
                                                          <option value="option_b" @if($question->correct_option == "option_b")selected @endif>Option B</option>
                                                          <option value="option_c" @if($question->correct_option == "option_c")selected @endif>Option C</option>
                                                          <option value="option_d" @if($question->correct_option == "option_d")selected @endif>Option D</option>
                                                      </select>
                                                  </div>

                                                  <div class="question-show btn col-md-12 mt-1 bg-light text-center">
                                                      <i class="fas fa-angle-double-down"></i>
                                                  </div>
                                                  <div class="question-hide btn col-md-12 mt-1 bg-light text-center d-none">
                                                      <i class="fas fa-angle-double-up"></i>
                                                  </div>
                                  ...
                                  @foreach($metas as $meta)
                                    <div class="col-md-12 border border-light rounded p-2">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <label>Value</label>
                                                <input type="text" key="{{ $meta["meta_key"] }}"class="form-control" types="meta" value="
                                                @if(array_key_exists($meta['meta_key'],$project->metas)) 
                                                {{ $project->metas[$meta["meta_key"]]->meta_value}} 
                                                @endif
                                                ">
                                            </div>
                                        </div>
...
{{--                                     
                        ...
                        <div class="form-group border border-light rounded p-1">
                            ...
                            <div class="p-5">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="hidden" name="file_attached" value="{{$project->medias}}">
                                          ...
                                          <div class="file m-1 image-contain">
                                              <a href="javascript:void(0);" data-id="{{ $file->id}}" class="file-select">
                                                  ...
                                                  <div class="file-name">
                                                      ...
                                                      <small>{{ $file->size }} mb <span class="date text-muted">{{ $file->date }}</span></small>
                                                  </div>
                                              </a>
                                          </div>
                                      </div>
