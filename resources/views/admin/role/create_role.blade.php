...
@section('content')
	...
	<section class="content">
		<form action="{{route('role.add')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
			{{csrf_field()}}
			<div class="row">
				<div class="col-md-12">
					<div class="dt-btns">
						...
						<div class="dt-bb"><h3>Add New Role</h3></div>
				...
				<div class="col-md-12 no-title">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name ="name" id="name" placeholder="Ex: User" value="{{old('name')}}">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name ="display_name" id="display_name" placeholder="Ex: User demo" value="{{old('display_name')}}">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<div class="col-sm-6">
								<input type="checkbox" name="permission[]" value="{{$id}}">{{$display_name}}
							</div>
							@endforeach
						</div>
					</div>
