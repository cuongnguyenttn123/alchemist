  ...
  <div class="modal fade modal-target" id="bidedit" tabindex="-1" role="dialog" aria-labelledby="popup-place-bid"
       aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form class="form-post_bid" method="post" action="{{$project->permalink()}}" data-parsley-validate>
            @csrf
            <div class="row">
              @include('template_part.content-modalbid', ['bid' => false])
            </div>
