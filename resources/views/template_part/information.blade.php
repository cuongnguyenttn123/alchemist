            ...
            <div class="card">
               ...
               <div id="collapseOne-{{$user->id}}-3" class="collapse " role="tabpanel" aria-labelledby="headingOne-1-3">
                  <div class="ui-block-title" style="padding-left: 20px;padding-right: 20px;border-bottom: solid; border-bottom-width: 1px;border-top-width: 0px;border-bottom-color: #E6ECF5">
                    ...
                    <div id="collapseOne-{{20+$user->id}}-{{$user->id+3}}" class="collapse " role="tabpanel" aria-labelledby="headingOne-{{20+$user->id}}-{{$user->id+3}}">
                      <div class="ui-block-title" style="padding-left: 20px;padding-right: 20px;border-bottom: solid; border-bottom-width: 1px;border-top-width: 0px;border-bottom-color: #E6ECF5">
                        <form class="w-search" ><div class="ui-block-content" style="margin: 0px;padding: 0px" >
                            <div class="crumina-module crumina-heading with-title-decoration " style="margin-bottom: 5px;" >
                              <h6 class="heading-title" style="padding-bottom: 15px;font-weight: 500">Average Rating: {{number_format((float)$user->rating, 1, '.', '')}}</h6>
                            </div>
                        ...
                        <div class="row" style="width: 100%;">
                           <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                              <ul class="widget w-last-photo js-zoom-gallery">
                                 ...
                                 <li>
                                    <div class="photo-album-item small-album"  style="position: relative;border-width: 1px; padding: 0px 0px 5px;">
                                       <a href="#"  data-toggle="modal" data-target="#create-photo-album"#
                                          ></a>
                                       <div class="content" style="padding: 20px 0px 0px 0px"> <a class="title h6" style="color: #8F8F8F" ><i class="fas fa-images"></i></a>
