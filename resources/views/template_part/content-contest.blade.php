<div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 sorting-item featured urgent open private nda " style="z-index: inherit">
      ...
      <div class="ui-block">
        ...
        <div class="comment-form-1 inline-items">
          ...
          @endif
          <a target="_blank" href="{{$contest->permalink()}}"  class="btn btn-md-2 btn-border-think c-grey btn-transparent custom-color" style="margin-top: 15px; padding: 13px 25px 13px 25px;">CONTEST DETAILS</a>
        </div>
      </div>
  @include('modal.entry')
</div>
