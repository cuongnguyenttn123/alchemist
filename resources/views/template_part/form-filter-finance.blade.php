      ...
      <div id="collapseFilter-{{$rand}}" class="collapse" role="tabpanel" aria-labelledby="headingOne-20" style="background-color: #EBF0F4;">
         <div class="ui-block responsive-flex1200" style="margin-top: 10px;margin-bottom: 0px;background-image: linear-gradient(#FCFCFC, #FAFBFD)">
            <div class="ui-block-title">
               <div class="w-select" align="left" >
                  <form class="w-search" style="width: inherit">
                     <div class="form-group with-button">
                        <input class="form-control" type="text" placeholder="Search Project ID....">
                        <button>
               ...
               <a href="#" data-toggle="modal" data-target="#create-photo-album" class="btn btn-primary btn-md-2" align="right">Filter</a>
               <button class="btn btn-md-2 btn-secondary button-filter-hp" align="right">
                  <img src="svg-icons/JobCard/refresh-page-arrow-button.svg" class="olymp-heart-icon">
               </button>
            </div>
         </div>
      </div>
